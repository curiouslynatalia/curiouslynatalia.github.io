---
title: what is attention design?
date: 2026-05-03
description: A brief description of the post for the card preview.
tags:
  - attention
  - intention
  - life-design
...
https://betterthanreels.substack.com

![https://www.youtube.com/watch?v=t9G5f5OCQzg]
...
![](https://images.squarespace-cdn.com/content/v1/68ffe9176e8683326214ec5a/5f9bc1c2-1421-4179-9218-35f5d6b60472/Burnout+Buddy.png?format=2500w)
...
[Burnout Buddy.](https://burnoutbuddy.io/)
...
1. Open Burnout Buddy
2. Click the + icon in the top right
3. Give your schema a name in ‘Step 1’ (eg. 30m limit)
4. Select all the apps and websites you want the schema to apply to in ‘Step 2’
5. Choose the schedule you want the schema to run on.  
	I currently have mine set as follows:

![](https://images.squarespace-cdn.com/content/v1/68ffe9176e8683326214ec5a/0d1d23bf-5440-47d1-9b2a-4731b8216003/Burnout+Buddy+Step+3.png?format=2500w)

1. Now set a daily usage limit.  
	Mine is set as follows:

![](https://images.squarespace-cdn.com/content/v1/68ffe9176e8683326214ec5a/c44e170c-1b50-4bab-b812-0baf3c0fdd16/Burnout+Buddy+Step+3+Usage.png?format=2500w)

1. Set custom/siri settings if desired (I personally don’t use these settings)
2. Enable ‘Strict Mode’ in the ‘Advanced’ section.
3. Hit ‘Publish’ in the top right.
...
1. Open Burnout Buddy
2. Click the + icon in the top right
3. Give your schema a name in ‘Step 1’ (eg. ‘Quiet Mornings’)
4. Select all the apps and websites you want the schema to apply to in ‘Step 2’  
...
![](https://images.squarespace-cdn.com/content/v1/68ffe9176e8683326214ec5a/7fa0ab7d-b47f-4c6f-81b1-3fed13e8bf65/Burnout+Buddy+Quiet+Mornings.png?format=2500w)

1. Choose the schedule you want the schema to run on.  
	I have mine set as follows:

![](https://images.squarespace-cdn.com/content/v1/68ffe9176e8683326214ec5a/dd3ffdc4-5680-476e-b446-1692353ad9e6/Burnout+Buddy+Quiet+Mornings+Schedule.png?format=2500w)

1. For this schema I don’t have a daily usage limit as this is purely for blocking apps and websites in the morning.
2. I also don’t have any custom/siri settings for this schema either but you can add them if you want.
3. Enable ‘Strict Mode’ in the ‘Advanced’ section.
4. Hit ‘Publish’ in the top right.
